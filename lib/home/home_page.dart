// ignore_for_file: use_super_parameters, no_leading_underscores_for_local_identifiers, sized_box_for_whitespace
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardColor =
        Colors.grey[200]!; // Warna card yang ingin digunakan
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: Colors.black, width: 2), // Garis tepi hitam
                ),
              ),
              CircleAvatar(
